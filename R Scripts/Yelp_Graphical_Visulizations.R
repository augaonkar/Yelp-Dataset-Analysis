...
#Abhilash Ugaonkar, Ketaki Tahtte, Yesha Dave
#This script expores graphical visulaization of yelp dataset 
...
con <- file("C:/Users/Abee/Documents/BIA/yelp_academic_dataset_business.json", "r")
...
yelpdata <- input %>% lapply(function(x) t(unlist(fromJSON(x)))) %>% 
   ldply()
